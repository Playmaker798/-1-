...
public final class FragmentCategoriesBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView textViewNoCategories;
  ...
  private FragmentCategoriesBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull TabLayout tabLayout, @NonNull TextView textViewNoCategories) {
    this.rootView = rootView;
    this.fabAddCategory = fabAddCategory;
    this.recyclerViewCategories = recyclerViewCategories;
    this.tabLayout = tabLayout;
    this.textViewNoCategories = textViewNoCategories;
  }
  ...
  public static FragmentCategoriesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.textViewNoCategories;
      TextView textViewNoCategories = ViewBindings.findChildViewById(rootView, id);
      if (textViewNoCategories == null) {
        break missingId;
      }

      return new FragmentCategoriesBinding((CoordinatorLayout) rootView, fabAddCategory,
          recyclerViewCategories, tabLayout, textViewNoCategories);
    }
